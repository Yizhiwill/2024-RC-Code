...
bool base_interfaces__srv__vision_angle__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces.srv._vision_angle.VisionAngle_Request", full_classname_dest, 53) == 0);
  }
  base_interfaces__srv__VisionAngle_Request * ros_message = _ros_message;
  {  // target_arm_angle1
...
{
  /* NOTE(esteve): Call constructor of VisionAngle_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces.srv._vision_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisionAngle_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool base_interfaces__srv__vision_angle__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces.srv._vision_angle.VisionAngle_Response", full_classname_dest, 54) == 0);
  }
  base_interfaces__srv__VisionAngle_Response * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of VisionAngle_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces.srv._vision_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisionAngle_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
