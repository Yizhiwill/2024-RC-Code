...
#ifndef BASE_INTERFACES__SRV__DETAIL__ARM_ANGLE__FUNCTIONS_H_
#define BASE_INTERFACES__SRV__DETAIL__ARM_ANGLE__FUNCTIONS_H_
...
/// Initialize srv/ArmAngle message.
/**
...
/// Create srv/ArmAngle message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces__srv__ArmAngle_Request__init().
...
/// Destroy srv/ArmAngle message.
/**
 * It calls
 * base_interfaces__srv__ArmAngle_Request__fini()
...
/// Check for srv/ArmAngle message equality.
/**
...
/// Initialize array of srv/ArmAngle messages.
/**
...
/// Finalize array of srv/ArmAngle messages.
/**
 * It calls
 * base_interfaces__srv__ArmAngle_Request__fini()
...
/// Create array of srv/ArmAngle messages.
/**
 * It allocates the memory for the array and calls
 * base_interfaces__srv__ArmAngle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ArmAngle messages.
/**
 * It calls
 * base_interfaces__srv__ArmAngle_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArmAngle message array equality.
/**
...
/// Copy an array of srv/ArmAngle messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces__srv__ArmAngle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__ArmAngle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It allocates the memory for the array and calls
 * base_interfaces__srv__ArmAngle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces
...
/**
 * It calls
 * base_interfaces__srv__ArmAngle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BASE_INTERFACES__SRV__DETAIL__ARM_ANGLE__FUNCTIONS_H_
