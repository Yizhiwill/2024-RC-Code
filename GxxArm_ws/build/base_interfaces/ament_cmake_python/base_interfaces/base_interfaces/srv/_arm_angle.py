...
class Metaclass_ArmAngle_Request(type):
    """Metaclass of message 'ArmAngle_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'base_interfaces.srv.ArmAngle_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arm_angle__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arm_angle__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arm_angle__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arm_angle__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arm_angle__request
...
class ArmAngle_Request(metaclass=Metaclass_ArmAngle_Request):
    """Message class 'ArmAngle_Request'."""
...
class Metaclass_ArmAngle_Response(type):
    """Metaclass of message 'ArmAngle_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'base_interfaces.srv.ArmAngle_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arm_angle__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arm_angle__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arm_angle__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arm_angle__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arm_angle__response
...
class ArmAngle_Response(metaclass=Metaclass_ArmAngle_Response):
    """Message class 'ArmAngle_Response'."""
...
class Metaclass_ArmAngle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'base_interfaces.srv.ArmAngle')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__arm_angle

            from base_interfaces.srv import _arm_angle
            if _arm_angle.Metaclass_ArmAngle_Request._TYPE_SUPPORT is None:
                _arm_angle.Metaclass_ArmAngle_Request.__import_type_support__()
            if _arm_angle.Metaclass_ArmAngle_Response._TYPE_SUPPORT is None:
                _arm_angle.Metaclass_ArmAngle_Response.__import_type_support__()


class ArmAngle(metaclass=Metaclass_ArmAngle):
    from base_interfaces.srv._arm_angle import ArmAngle_Request as Request
    from base_interfaces.srv._arm_angle import ArmAngle_Response as Response
