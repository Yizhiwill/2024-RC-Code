...
#include "base_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStatus__ros_msg_type = base_interfaces__msg__RobotStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: real_arm_angle1
  {
    cdr << ros_message->real_arm_angle1;
  }

  // Field name: real_arm_angle2
  {
    cdr << ros_message->real_arm_angle2;
  }

  // Field name: real_arm_angle3
  {
    cdr << ros_message->real_arm_angle3;
  }

  // Field name: real_arm_angle4
  {
    cdr << ros_message->real_arm_angle4;
  }

  // Field name: real_arm_angle5
  {
    cdr << ros_message->real_arm_angle5;
  }

  // Field name: real_arm_angle6
  {
...
size_t get_serialized_size_base_interfaces__msg__RobotStatus(
  const void * untyped_ros_message,
...
static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interfaces__msg__RobotStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interfaces
size_t max_serialized_size_base_interfaces__msg__RobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interfaces__msg__RobotStatus;
    is_plain =
      (
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces__msg__RobotStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interfaces, msg, RobotStatus)() {
